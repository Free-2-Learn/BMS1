...
*/
// 🔁 GLOBAL: Utility to calculate age from birthdate
...
window.openEditModal = async function (residentId) {
    ...
    document.getElementById("edit-age").value = calculateAge(resident.birthdate);
...
// Automatically update age when birthdate is selected (Add Form)
...
// Automatically update age when birthdate is selected (Edit Form)
